...
<form id="registration-form" style="display: none;" class="validate-form" onsubmit="return false;"
    ...
    <br><br><div ><div class="_contact">
    <div class="inputs _contact-inputq-group">
        ...
        <div class="inputq company-list-container">
    ...
    <button class="buttonq" type="submit">Участвовать в выбранных вебинарах</button>
    <hr>
